...
// запись кат
     if ($argv[3]!=-1) {
      ...
      if (!empty( trim( $value['Раздел']))){
              $cat_temp=$cat_temp.$cat_delimiter.$value['Раздел']; 
      }    
$temp['cat']=$cat_temp;
//     id
$temp['id']=$argv[4]++;
/*$temp['id']=789;*/
$temp['name']=$value['Наименование'];
...
/*fputcsv($fp,['_CATEGORY_','_ID_','_NAME_','_MODEL_','_SKU_','_UPC_','_MANUFACTURER_','_SHIPPING_','_LOCATION_','_PRICE_','_POINTS_','_QUANTITY_','_STOCK_STATUS_ID_','_LENGTH_','_WIDTH_','_HEIGHT_','_WEIGHT_','_SEO_KEYWORD_','_META_KEYWORDS_','_META_DESCRIPTION_','_DESCRIPTION_','_IMAGE_','_SORT_ORDER_','_STATUS_','_DISCOUNT_','_SPECIAL_'], ';');*/
